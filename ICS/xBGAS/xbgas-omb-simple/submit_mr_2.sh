...
#SBATCH --output=results/get_seq_mr_200ns_%A.out     # Standard output log (%j expands to job ID)
...
mpirun --hostfile output4.txt -n 1 sst -n 2 rev-xbgas-omb-2.py --model-options="osu_oshm_get_seq_mr.exe 2"
