...
#SBATCH --output=results/omb_%A_%a.out     # Standard output log (%j expands to job ID)
...
applications=("osu_oshm_get.exe" "osu_oshm_put.exe" "osu_oshm_get_nb.exe" "osu_oshm_put_nb.exe" "osu_oshm_get_mr.exe" "osu_oshm_put_mr.exe" "osu_oshm_get_nb_mr.exe" "osu_oshm_put_nb_mr.exe")
