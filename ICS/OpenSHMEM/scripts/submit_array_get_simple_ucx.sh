...
#SBATCH --output=results/r0/get_mr_ucx_%a.out     # Standard output log (%j expands to job ID)
...
# Profile with UCX
UCX_PROFILE_MODE=accum UCX_PROFILE_FILE=$DEST_DIR/ucx_simple_$MESSAGE_SIZE.prof \
