...
#SBATCH --output=results/put_mr_%a_%j.out     # Standard output log (%j expands to job ID)
#SBATCH --error=results/put_mr_%a_%j.err      # Standard error log (%j expands to job ID)
